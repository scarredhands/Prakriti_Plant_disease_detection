...
import 'package:prakriti_plant_disease_detection/widgets/bottom_nav_bar.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Map<String, dynamic> getDiseaseDetails(String diseaseName) {
    Map<String, Map<String, String>> diseaseDetails = {
      "Aphid": {
        "description": "1. Clusters of small, soft-bodied insects (green, black, or brown) on leaves and stems\n 2.Curling, yellowing, and wilting of leaves due to sap sucking.\n3.Honeydew secretion leads to sooty mold growth, blocking photosynthesis.\n4.Transmit viral diseases like Barley Yellow Dwarf Virus (BYDV).",
        "treatment": "1. Spray insecticides like Imidacloprid or Thiamethoxam at early infestation.\n2. Early sowing to avoid peak aphid activity.\n3. Encourage natural predators (ladybugs, lacewings), destroy weeds that act as aphid hosts.",
        "localRemedies": " Neem oil spray (natural insect repellent), Garlic-chili extract spray to deter aphids.",
      },
      "Black Rust": {
        "description": "1. Reddish-brown pustules (a small pimple-like eruption from the surface of part of a plant) on leaves and stems, later turning black.\n2. Weakens plants, causes lodging (plants falling over) and yield loss.\n3. Occurs in warm temperatures (18-30°C) and high humidity.",
        "treatment": "1. Spray fungicides at early stages. e.g. Propiconazole, Tebuconazole, or Mancozeb\n2. Grow resistant varieties (e.g., HD 2967), remove barberry plants (thorny shrubs), and practice crop rotation.",
        "localRemedies": "Spray neem extract, garlic extract, or a cow dung-buttermilk solution for antifungal effects..",
      },
      "Blast": {
        "description": "1. Grayish lesions (spots or areas of damage or abnormal tissue development on a plant) on spikes (grain bearing organ), leading to premature bleaching.\n2. Infected grains shrink, become chalky (paleness of colour), and fail to develop properly.\n3. Occurs in warm, humid conditions (18–30°C) with frequent rain.",
        "treatment": "1. Spray fungicides at early stages. e.g. Tebuconazole or Azoxystrobin.\n2. Use blast-resistant wheat varieties, practice crop rotation, and avoid late sowing.",
        "localRemedies": "Neem oil spray (antifungal properties), Cow dung-buttermilk solution to suppress fungal spores, Wood ash dusting around plants to absorb moisture and limit fungal spread.",
      },
      "Brown Rust": {
        "description": "1. Small, circular orange-brown pustules (a small pimple-like eruption from the surface of part of a plant) on leaves, mainly on the upper surface.\n2. Severe infection causes yellowing, drying, and early leaf drop, reducing yield.\n3. Favored by cool temperatures (15–22°C) and moisture.",
        "treatment": "1. Spray fungicides at early stages. e.g. Propiconazole, Tebuconazole\n2. Grow rust-resistant varieties (e.g., HD 2967), practice crop rotation, and avoid excessive nitrogen fertilization.",
        "localRemedies": "Spray neem extract, garlic extract, or a cow dung-buttermilk solution (boost plant immunity) for antifungal effects..",
      },
      "Common Root Rot": {
        "description": "1. Dark brown to black lesions (spots or areas of damage or abnormal tissue development on a plant) on roots and lower stem.\n2. Stunted growth, yellowing, and wilting of plants.\n3. Roots become brittle and decay, leading to plant death in severe cases.\n4. Occurs in warm, dry soils with poor drainage.",
        "treatment": "1. Treat seeds with fungicides like Carbendazim or Thiram before sowing.\n2. Rotate crops with non-hosts (e.g., pulses, mustard), improve soil drainage and avoid overcrowding plants, use healthy, disease-free seeds.",
        "localRemedies": "3. Neem cake or mustard cake in the soil to suppress fungi, cow dung compost to enhance beneficial microbes in soil.\n4. Trichoderma bio-fungicide (mix with compost or apply to seeds).",
      },
      "Fusarium Head Blight": {
        "description": "1. Bleached, whitish spikelet's on wheat heads.\n2. Shriveled, discolored grains with a pinkish or white fungal growth.\n3. Produces mycotoxins (DON toxin), making grains unsafe for consumption.\n4. Favored by warm, humid weather (20–30°C) and prolonged moisture.",
